...
// CHECK-LABEL: @rehsape_0d_to_0d_folds(%arg0: tensor<f32>)
func.func @rehsape_0d_to_0d_folds(%arg0: tensor<f32>) -> tensor<f32> {
  %0 = stablehlo.reshape %arg0 : (tensor<f32>) -> tensor<f32>
  // CHECK: return %arg0 : tensor<f32>
  return %0 : tensor<f32>
}

// CHECK-LABEL: @rehsape_0d_to_2d_splats(%arg0: tensor<f32>)
func.func @rehsape_0d_to_2d_splats(%arg0: tensor<f32>) -> tensor<1x1xf32> {
  ...
  // CHECK: return %[[SPLAT]] : tensor<1x1xf32>
  return %0 : tensor<1x1xf32>
}

// CHECK-LABEL: @rehsape_2d_to_0d_reduces(%arg0: tensor<1x1xf32>)
func.func @rehsape_2d_to_0d_reduces(%arg0: tensor<1x1xf32>) -> tensor<f32> {
  ...
  // CHECK: return %[[TO_TENSOR]] : tensor<f32>
  return %0 : tensor<f32>
}
